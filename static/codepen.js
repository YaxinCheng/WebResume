...
CodeBlockCodePen.prototype.MDLIBS = ["<!-- Material Design Lite -->", '<script src="https://code.getmdl.io/1.1.3/material.min.js"></script>', '<link rel="stylesheet" href="https://code.getmdl.io/1.1.3/material.indigo-pink.min.css">', "<!-- Material Design icon font -->", '<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">'], CodeBlockCodePen.prototype.init = function() {
    "use strict";
    ...
    "use strict";
    for (var i, o, s = ""; - 1 !== n.indexOf(t);)
        i = n.indexOf(t), o = n.indexOf(e), s += n.substring(i + t.length, o), n = n.substring(0, i).trim() + "\n" + n.substr(o + e.length).trim();
    return {
        textRemainder: n,
        tagContent: s
    }
    ...
    return function() {
        ...
        var n = e.textContent.replace("../assets/demos/", window.location.origin + "/assets/demos/"), i = this.extractTagsContent("<style>", "</style>", n);
        n = i.textRemainder;
        var o = i.tagContent.trim(), s = this.extractTagsContent("<script>", "</script>", n);
        n = s.textRemainder.trim();
        for (var r = s.tagContent.trim(); t.firstChild;)
