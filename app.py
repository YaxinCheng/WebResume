...
def index():
    ...
    introduction = {"Type": 0, "Title": "Introduction", "Description":
                ...
                ✶ Habit: Coding &amp; Watching shows(Game of Thrones, Silicon Valley)<br>
                ...
                ✶ Quick answer to one frequent question: I do wanna stay in Canada after graduation<br>
                ✶ Favourite languages: Swift > Python > C""",
                    "Image": False,
                    "MoreButton": True,
